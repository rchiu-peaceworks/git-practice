...
**Who it's for:** English- and Chinese-speaking tourists who want to eat where locals actually eat — not the restaurants every guidebook, Tripadvisor list, and Instagram account already sends them to.
...
- Places chosen for ambiance/photogenic value over the food itself

**Done when:** this file exists with the inclusion test above — every place in the shortlist (Task 8) gets measured against it.
